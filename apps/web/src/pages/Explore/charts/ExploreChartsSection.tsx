...
function VolumeChartSection({ chainId }: { chainId: number }) {
  ...
  if (isSmallScreen) {
    return (
      <MinimalStatDisplay
        title={<Trans>TacitusSwap volume</Trans>}
  ...
  return (
    <SectionContainer>
      <RowBetween>
        <SectionTitle>
          <Trans>TacitusSwap volume</Trans>
        </SectionTitle>
...
function TVLChartSection({ chainId }: { chainId: number }) {
  ...
  if (isSmallScreen) {
    ...
    return <MinimalStatDisplay title={<Trans>TacitusSwap TVL</Trans>} value={currentTVL} />
  }

  return (
    <SectionContainer>
      <SectionTitle>
        <Trans>TacitusSwap TVL</Trans>
      </SectionTitle>
      {(() => {
        if (dataQuality === DataQuality.INVALID) {
          const errorText = loading ? undefined : (
